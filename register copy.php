        ...
        <div class="form">
            <form name="registration" action="" autocomplete="off" method="post" id="forms">
                <div class="login-box">
                    ...
                    <div class="textbox">
                        ...
                        <input type="text" placeholder="Họ và tên" id="name" name="name" required class="required">
                    </div>
                    <div class="textbox">
                        <i class="fas fa-birthday-cake"></i>
                        <input type="date" placeholder="Ngày sinh" id="date" name="date">
                    </div>
                    <div class="textbox">
                        <i class="fas fa-venus-mars"></i>
                        <input type="text" placeholder="Giới tính (Nam hoặc Nữ)" id="gender" name="gender" value="Nam">
                    ...
                    <div class="textbox">
                        ...
                        <input type="email" style="color:white" placeholder="Email" autocomplete="off" id="email" name="email" required class="required"><br>
            ...
            <small class="right_email" style="color: green, font-size: 15px"></small> -->
                    ...
                    <div class="textbox">
                        ...
                        <input type="number" placeholder="Số điện thoại" id="phone" name="phone">
                    </div>
                    <div class="textbox">
                        <i class="fas fa-lock"></i>
                        <input type="Password" placeholder="Mật khẩu" autocomplete="off" id="password" name="password" required class="required">
                    </div>
                    <div class="textbox">
                        <i class="fas fa-lock"></i>
                        <input type="Password" placeholder="Xác nhận mật khẩu" id="pass_check" name="pass_check" required class="required">
