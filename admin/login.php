...
if (!empty($_POST)) {
    ...
    if (empty($error)) {
        ...
        if ($result) {
            ...
            if(isset($_POST['remember']) && !isset($_COOKIE['user']) && !isset($_COOKIE['user'])){
                                ...
                                <div class="p-5">
                                    ...
                                    <form action="" method="POST" class="user" id="login">
                                        <div class="form-group">
                                            <input type="email" name="u_name" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nhập email hoặc số điện thoại..." value="<?php if(isset($_COOKIE['user'])) echo $_COOKIE['user']; ?>">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="u_pass" class="form-control form-control-user" id="exampleInputPassword" placeholder="Mật khẩu" value="<?php if(isset($_COOKIE['pass'])) echo $_COOKIE['pass']; ?>">
