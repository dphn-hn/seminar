...
<div class="shop-main-area mb-70 pl-100">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pl-50">
									...
									<div class="product-wrapper mb-40" id="product">
										...
										<div class="product-link">
											<div class="product-button">
												<a href="xuli-cart.php?action=add&id=<?php echo $value['id']; ?>" title="Add to cart" data-toggle="modal" data-target="#login-modal"><i class="fa fa-shopping-cart"></i>Thêm Vào Giỏ</a>
												<a href="#" class="myBtn">
